    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(blank=True, choices=[('uz', 'Uzbek'), ('en', 'English'), ('ru', 'Russian')], max_length=5, null=True)),
                ...
                ('invited_code', models.CharField(blank=True, max_length=20, null=True)),
